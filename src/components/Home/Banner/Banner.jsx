...
import Button from "@/components/Shared/LottieFile";
      ...
      <div className="max-w-6xl px-7 xl:px-0 mx-auto flex flex-col md:flex-row gap-4 md:gap-0  items-center justify-between md:h-[550px] z-0 pt-5">
        <div className="max-w-md">
          ...
          <p className="mb-5 text-justify">
            Smart-Madrasha.com is an educational institution management service
            to help institutes for save their time and improve management
            system. It is a simple yet powerful one point integrated platform
            that connects all the departments with its technologically advanced
