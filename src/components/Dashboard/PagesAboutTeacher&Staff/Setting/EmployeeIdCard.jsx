...
const EmployeeIdCard = () => {
  return (
    <div className="">
      <div className="bg-white mx-auto h-[500px] rounded-2xl shadow-md w-[320px] border relative overflow-hidden">
        <div className="w-[400px] h-64 bg-[#1e1969] absolute rounded-r-xl -right-[72px] -top-[72px] z-[10]"></div>
        <div className="w-full h-24 bg-[#6ABC48] absolute  rounded-xl top-24 -left-44 rotate-[30deg] z-[10]"></div>
        <div className="w-full h-24 bg-[#6ABC48] absolute  rounded-xl top-24 -right-44 -rotate-[30deg] z-[10]"></div>

        <div className="absolute z-[100] flex  w-full p-4 justify-between mt-1 ">
          ...
          <div className=" w-full text-white mt-2">
            <div className="">
              <p className="text-[9px]">
                আলহাজ্ব আবুল কাশেম ও মরহুমা ফাতেমা খাতুন
              </p>
              <p className="font-bold text-[19px] -mt-1">
                মারকাযুল কুরআন মাদ্রাসা
              </p>
            </div>
          </div>
        </div>
        <div className="absolute z-30 top-[98px] right-[74px]">
        ...
        <div className="w-full h-14 bg-[#6ABC48] absolute -rotate-[30deg] -bottom-4 -right-32 z-10"></div>
        <div className="w-24 h-14 bg-[#221E54] absolute -rotate-[30deg] rounded-xl -bottom-5 -right-14 z-20"></div>
      </div>
    </div>
  );
};
